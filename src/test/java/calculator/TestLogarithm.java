...
import calculator.operation.Logarithm;
...
public class TestLogarithm {
    ...
    void testConstructor2() {
        // A Times expression should not be the same as a Logarithm expression
        try {
    ...
    void testEquals() {
        ...
        try {
            Logarithm<BigDecimal> d = new Logarithm<>(p);
            assertEquals(op, d);
        } catch (IllegalConstruction e) {
            fail();
        }
    ...
    void testHashCode() {
        ...
        List<Expression<BigDecimal>> p = List.of(new MyBigNumber(BigDecimal.valueOf(value1)));
        try {
            Logarithm<BigDecimal> e = new Logarithm<>(p);
    ...
    void testNullParamList() {
        params = null;
        assertThrows(IllegalConstruction.class, () -> op = new Logarithm<>(params));
    }

    @Test
    void testMoreOneParam() {
        assertThrows(IllegalConstruction.class, () -> new Logarithm<>(List.of(new MyBigNumber(4), new MyBigNumber(5))));
    }
